# Map Competitors
 ...
 <span style="font-size: 16.428572;">
...
Feels like hiring a $20k strategy consultant.
 ...
 </span> <span style="font-size: 16.428572;">
     Variable List:

Here are the input variables the prompt expects you to supply before it can run:

COMPANY – The exact business name to analyze.
INDUSTRY – A clear label for the sector or market in which the company operates.
current_focus – One concise paragraph covering:
What the company does today
Key revenue streams
Pricing model
Primary customer segments
Any current growth tactics in use
known_challenges – A list or paragraph describing the biggest obstacles the company is facing (e.g., slowing user growth, rising CAC, regulatory pressure).
...
‹context> <business_name>{{COMPANY})</business_name> 
...
<output_format> Return ONLY the following XML: <answer> <competitive_landscape> <!-- bullet list of competitors & key data --> </competitive_landscape> ‹opportunity gaps> <!-- numbered list of untapped levers
