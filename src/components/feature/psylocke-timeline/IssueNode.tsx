  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className={`relative w-[100px] h-[150px] md:w-[120px] md:h-[180px] rounded-lg overflow-hidden border-2 cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-lavender focus-visible:ring-offset-2 ${
          isActive
