...
const socialLinks = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/saren/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Mastodon",
    href: "https://mastodon.social/@saren",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-charcoal to-offblack text-ash border-t border-charcoal/20 dark:border-ash/10 pt-[60px] pb-16 md:pb-20" data-pagefind-ignore>
