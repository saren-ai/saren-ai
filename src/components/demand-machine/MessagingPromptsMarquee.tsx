...
function MarqueeRow({
    ...
    return (
        <div className="relative overflow-hidden py-3">
            {/* Fade Gradients */}
            <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-[#0A0E14] to-transparent z-10" />
            <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-[#0A0E14] to-transparent z-10" />
        ...
        >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/[0.02]">
                <div className="flex items-baseline gap-3">
                    ...
                    <span className="text-[10px] text-white/20">v1.2 — 23 modules</span>
                </div>
