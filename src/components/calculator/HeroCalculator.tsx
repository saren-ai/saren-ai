...
export default function HeroCalculator() {
    return (
        <section className="hero-card relative w-full bg-background-secondary text-foreground overflow-hidden min-h-[800px] flex items-center justify-center pt-24 pb-20">
            {/* Background Ambience */}
