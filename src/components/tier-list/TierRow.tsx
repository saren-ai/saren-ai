...
export function TierRow({ tier, toolIds, tools }: TierRowProps) {
  ...
  return (
    <div className="flex items-stretch">
      {/* Tier Label */}
      <div
        className="w-14 md:w-20 flex items-center justify-center font-bold text-xl md:text-2xl shrink-0 rounded-l-lg"
      ...
      <div
        ref={setNodeRef}
        className={`flex-1 flex flex-wrap items-center gap-2 p-2 md:p-3 rounded-r-lg border transition-colors min-h-[72px] ${
          isOver
