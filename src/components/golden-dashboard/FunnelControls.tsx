    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-lavender/10 hover:bg-lavender/20 text-lavender rounded-lg transition-colors font-medium"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {Object.entries(presets).map(([key, preset]) => (
                    <button
                      ...
                      className="p-3 bg-charcoal/5 dark:bg-ash/5 hover:bg-lavender/10 border border-border hover:border-lavender rounded-lg transition-all text-left group"
                    >
                      <div className="font-semibold text-foreground group-hover:text-lavender transition-colors text-sm">
                        {preset.name}
                      </div>
