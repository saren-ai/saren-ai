                ...
                className={`
                  ...
                  ${
                    activeLayer === layer.id
                      ? "bg-lavender text-white shadow-lg scale-105"
                      : "bg-card-bg border-2 border-border text-foreground hover:border-lavender"
                  }
                `}
              >
    ...
    <div className="space-y-6">
      ...
      <div className="pt-4 border-t border-border">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-lavender/10 hover:bg-lavender/20 text-lavender rounded-lg transition-colors font-medium"
        >
