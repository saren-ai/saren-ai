...
export default function HeroBehavioralScoring() {
    return (
                    ...
                    <div className="lg:col-span-12 mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg text-foreground-muted max-w-xl leading-relaxed">
                                Making buyer motion legible across the journey. A system that connects behavior, engaged content, and readiness into a single explainable score.
                            </p>
                        </div>
                    </div>

                    {/* Interactive Simulator Area */}
                    <div className="lg:col-span-12 w-full bg-card-bg/50 border border-border rounded-xl p-6 backdrop-blur-sm">
                        <BehavioralSimulator />
                    </div>
