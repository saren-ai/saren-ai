...
import TouchDots from "@/components/desk/TouchDots";
import ThreadBubble, { type ThreadItem } from "@/components/desk/ThreadBubble";
import JobTriggers, { type AgentJob } from "@/components/desk/JobTriggers";
  ...
  return (
    <div className="min-h-screen bg-background p-8 max-w-7xl mx-auto">
      <p className="text-foreground-muted text-xs font-mono mb-6">
        <Link href="/desk" className="hover:text-foreground transition-colors">desk</Link>
