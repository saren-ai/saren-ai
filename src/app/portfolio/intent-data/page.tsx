...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://saren.ai/portfolio/intent-data" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://saren.ai/portfolio/intent-data/#webpage",
            "url": "https://saren.ai/portfolio/intent-data",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Intent Data as Funnel Intelligence", "item": "https://saren.ai/portfolio/intent-data" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "CreativeWork",
            "@id": "https://saren.ai/portfolio/intent-data/#work",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "HowTo",
            "@id": "https://saren.ai/portfolio/intent-data/#howto",
