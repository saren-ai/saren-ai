...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://saren.ai/portfolio/dynamic-nurture" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://saren.ai/portfolio/dynamic-nurture/#webpage",
            "url": "https://saren.ai/portfolio/dynamic-nurture",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Dynamic Email Nurture", "item": "https://saren.ai/portfolio/dynamic-nurture" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "CreativeWork",
            "@id": "https://saren.ai/portfolio/dynamic-nurture/#work",
