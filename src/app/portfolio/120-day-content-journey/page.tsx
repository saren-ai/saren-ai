...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://saren.ai/portfolio/120-day-content-journey" },
  openGraph: {
    title: "120-Day Content Journey | Saren.ai",
    description:
      "Engineering demand at scale. A system that maps content to buyer psychology across the entire decision lifecycle.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://saren.ai/portfolio/120-day-content-journey/#webpage",
            "url": "https://saren.ai/portfolio/120-day-content-journey",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "120-Day Content Journey", "item": "https://saren.ai/portfolio/120-day-content-journey" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "CreativeWork",
            "@id": "https://saren.ai/portfolio/120-day-content-journey/#work",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "HowTo",
            "@id": "https://saren.ai/portfolio/120-day-content-journey/#howto",
