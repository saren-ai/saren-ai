...
export const metadata: Metadata = {
  ...
  description:
    "How saren.ai collects, uses, and protects your information — analytics, cookies, and your rights.",
...
const sections = [
  ...
  },
  {
    ...
    body: [
      "I use a small set of service providers to run this site: Vercel (hosting), Supabase (database and file storage), Google (analytics), Sentry (error monitoring), and Calendly (if you book a call). Each receives only what it needs to do its job.",
  ...
  },
  {
    ...
    body: [
      "Emails are kept as ordinary business correspondence. Analytics data is retained per Google Analytics' standard retention settings.",
    ],
  },
  {
    heading: "Your rights",
