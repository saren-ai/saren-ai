  ...
  return (
    ...
    <article>
      ...
      <CaseStudyHero
        ...
        actions={[
          { label: "Start Framework", href: "/playbooks/b2b-marketing-framework/target-market-competitive-landscape", variant: "primary" },
      ...
      {/* Related Work */}
      <RelatedWork currentHref="/playbooks/b2b-marketing-framework" />
    </article>
    </>
  );
}
