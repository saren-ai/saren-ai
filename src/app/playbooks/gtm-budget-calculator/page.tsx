      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://saren.ai/playbooks/gtm-budget-calculator/#webpage",
            "url": "https://saren.ai/playbooks/gtm-budget-calculator",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "GTM Budget Calculator", "item": "https://saren.ai/playbooks/gtm-budget-calculator" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": "https://saren.ai/playbooks/gtm-budget-calculator/#work",
