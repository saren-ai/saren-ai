      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://saren.ai/playbooks/its-good-to-be-pitched/#webpage",
            "url": "https://saren.ai/playbooks/its-good-to-be-pitched",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "It's Good to be Pitched", "item": "https://saren.ai/playbooks/its-good-to-be-pitched" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "CreativeWork",
            "@id": "https://saren.ai/playbooks/its-good-to-be-pitched/#work",
